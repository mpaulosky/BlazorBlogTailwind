...
// File Name :     WhenNavMenuIsLoaded.cs
// Company :       mpaulosky
...
namespace BlazorBlog.Web.BUnitTests.Shared.GivenNavMenuComponent;

[ExcludeFromCodeCoverage]
public class WhenNavMenuIsLoaded : TestContext
{
	private readonly Mock<ILocalStorageService> _localStorageMock;

	public WhenNavMenuIsLoaded()
	{
		_localStorageMock = new Mock<ILocalStorageService>();
	}

	[Fact(DisplayName = "Should Display NavMenu")]
	public void ShouldDisplayNavMenu_Test()
	{
		// Arrange
